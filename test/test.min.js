app.controller("TestCtrl",function(a,c,e,f){a.init=function(){a.authorize().then(function(b){console.log(b)},function(b){console.log(b);a.error(b)})};a.authorize=function(){var b=c.defer();$.get("../resources/js/stjoscarboro-api.data",function(a){a=JSON.parse(Base64.decode(a));var d={alg:"RS256",typ:"JWT"},c={iss:a.client_email,scope:"https://www.googleapis.com/auth/drive https://www.googleapis.com/auth/spreadsheets",aud:a.token_uri,sub:Base64.decode(gapiids[0]),iat:KJUR.jws.IntDate.get("now"),exp:KJUR.jws.IntDate.get("now + 1hour")};
