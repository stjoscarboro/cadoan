...
h.pick(a.song,"title","category","author","others"));k.close()})};a.cancel=function(){k.close()}}});k.opened.then(function(){e(function(){h.scrollFrame()},100)})};a.search=function(a){$(".table").DataTable().search(a).draw()};a.save=function(){var c=b.defer();g.updateFile(a.song.id,{description:JSON.stringify({title:a.song.title,author:a.song.author,category:a.song.category,others:a.song.others})}).then(function(){c.resolve()});return c.promise};a.loadData=function(){var c=b.defer();b.all([g.listFolder("cadoan.sheets")]).then(function(b){b=
$jscomp.makeIterator(b[0]);for(var d=b.next();!d.done;d=b.next())Array.prototype.push.apply(a.songs,d.value);a.categories=f.listCategories(a.songs);a.authors=f.listAuthors(a.songs);f.sortByLocale(a.songs,"title");f.sortByLocale(a.authors,"name");f.sortCategories(a.categories);c.resolve()});return c.promise}}]);
