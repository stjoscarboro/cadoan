...
15,25,50,"All"]],dom:'<fpl<t>i<"dataTables_drive">>',initComplete:function(){a.accessToken&&$(".dataTables_drive").append('<a href="'+a.driveURL+'" target="_blank" title="Danh S\u00e1ch B\u00e0i H\u00e1t" class="drive-icon"></a>');h.resizeFrame(a)}})},1)};a.edit=function(b){var c=l("filter")(a.songs,{id:b})[0];a.song=angular.copy(c);var k=d.open({scope:a,templateUrl:"editor.html",backdrop:"static",backdropClass:"light",keyboard:!1,controller:function(){a.submit=function(){g.updateFile(a.song.id,{description:JSON.stringify({title:a.song.title,
author:a.song.author,category:a.song.category,others:a.song.others})});Object.assign(c,h.pick(a.song,"title","category","author","others"));k.close()};a.cancel=function(){k.close()}}});k.opened.then(function(){e(function(){h.scrollFrame()},100)})};a.search=function(a){$(".table").DataTable().search(a).draw()};a.loadData=function(){var c=b.defer();b.all([g.listFolder("cadoan.sheets")]).then(function(b){b=$jscomp.makeIterator(b[0]);for(var d=b.next();!d.done;d=b.next())Array.prototype.push.apply(a.songs,
d.value);a.categories=f.listCategories(a.songs);a.authors=f.listAuthors(a.songs);f.sortByLocale(a.songs,"title");f.sortByLocale(a.authors,"name");f.sortCategories(a.categories);c.resolve()});return c.promise}}]);
