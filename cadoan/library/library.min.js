...
app.controller("LibraryCtrl",["$scope","$q","$window","$uibModal","$timeout","$filter","$document","GoogleService","SheetsService","DriveService","AppUtil",function(a,b,c,d,e,l,m,n,f,g,h){a.init=function(){a.songs=[];a.categories=[];a.authors=[];a.song={};a.dateFormat="DD, dd/mm/yy";a.driveURL=g.getFolderURL("cadoan.music.sheets.id");a.pageSize=10;a.pageCounter=1;a.maxSize=7;m.ready(function(){0===c.angular.element(".signin").length&&a.loadData().then(function(){a.get()})})};a.signin=function(b,c){a.profile=
