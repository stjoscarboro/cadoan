...
b;a.accessToken=c;n.setAccessToken(c);a.loadData().then(function(){a.get()})};a.get=function(){var c=[{width:"calc(45% - 16)",targets:0},{width:"35%",targets:1},{width:"20%",targets:2},{width:16,targets:3,visible:null!==a.accessToken&&void 0!==a.accessToken,searchable:!1,orderable:!1},{width:0,targets:4,visible:!1,type:"hidden"}];e(function(){$(".table").DataTable({language:{url:"../../resources/js/datatables-vi.json"},columns:c,autoWidth:!1,ordering:!1,pageLength:15,lengthMenu:[[10,15,25,50,-1],
