...
app.controller("LibraryCtrl",["$scope","$q","$window","$uibModal","$timeout","$filter","$document","GoogleService","AirtableChoirService","AirtableFilesService","AppUtil",function(a,c,b,d,e,l,m,n,f,h,g){a.init=function(){a.songs=[];a.categories=[];a.authors=[];a.song={};a.dateFormat="DD, dd/mm/yy";a.driveURL=h.getDriveURL();a.pageSize=10;a.pageCounter=1;a.maxSize=7;m.ready(function(){0===b.angular.element(".signin").length&&a.loadData().then(function(){a.get()})})};a.signin=function(b,c){a.profile=
...
[10,15,25,50,"All"]],dom:'<fpl<t>i<"dataTables_drive">>',initComplete:function(){a.accessToken&&$(".dataTables_drive").append('Danh S\u00e1ch B\u00e0i H\u00e1t \u27a1 <a href="'+a.driveURL+'" target="_blank" title="Danh S\u00e1ch B\u00e0i H\u00e1t" class="drive-icon"></a>');g.resizeFrame(a)}})},1)};a.edit=function(c){var b=l("filter")(a.songs,{id:c})[0];a.song=angular.copy(b);var k=d.open({scope:a,templateUrl:"editor.html",backdrop:"static",backdropClass:"light",keyboard:!1,controller:function(){a.submit=
function(){a.save().then(function(){Object.assign(b,g.pick(a.song,"title","category","author","others"));a.refresh();k.close()})};a.cancel=function(){k.close()}}});k.opened.then(function(){e(function(){g.scrollFrame()},100)})};a.search=function(a){$(".table").DataTable().search(a).draw()};a.save=function(){var b=c.defer(),d=g.pick(a.song,"id","title","author","category","others");h.updateFile(a.song.refId,d).then(function(){b.resolve()});return b.promise};a.refresh=function(){a.categories=f.listCategories(a.songs);
a.authors=f.listAuthors(a.songs);$(".table").DataTable().draw(!1)};a.loadData=function(){var b=c.defer();h.loadFiles().then(function(c){Array.prototype.push.apply(a.songs,c);a.categories=f.listCategories(a.songs);a.authors=f.listAuthors(a.songs);f.sortByLocale(a.songs,"title");b.resolve()});return b.promise}}]);
