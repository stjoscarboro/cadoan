...
a.id+":batchUpdate",c,h)},loadYears:function(){var g=a.defer(),c=[];e.getSheetData("liturgies.years").then(function(a){(a=a.data.values)&&a.forEach(function(a){a[1]&&c.push({id:a[0],name:a[1],start:l(a[2])})});g.resolve(c)},function(a){console.log(a.data.error)});return g.promise},loadLiturgies:function(){for(var g=[],c=a.defer(),h=[],b=1;3>=b;b++)h.push(a.resolve(e.getSheetData("liturgies."+b),function(a){(a=a.data.values)&&a.forEach(function(a){a[3]&&g.push({id:a[0],name:a[1],year:a[2],date:l(a[3]),
special:a[4]})})}));a.all(h).then(function(){c.resolve(g)});return c.promise},loadSingers:function(){var g=a.defer(),c=[];e.getSheetData("cadoan.singers").then(function(a){(a=a.data.values)&&a.forEach(function(a){a[1]&&c.push({id:a[0],name:a[1]})});g.resolve(c)},function(a){console.log(a.data.error)});return g.promise},loadSchedules:function(g){var c=a.defer(),h=[];e.getSheetData("cadoan.schedules").then(function(a){(a=a.data.values)&&a.forEach(function(a){var c=l(a[0]),b=JSON.parse(a[1]);a=JSON.parse(a[2]);
