...
app.factory("DataService",["$q","HttpService","AppUtil",function(a,b,d){var f={liturgies:{years:{id:"1iax4O8R0IiZd9N77bK9XNRDllG40ZUJL7wiGCZocUak",range:"Years!A:D"},1:{id:"1iax4O8R0IiZd9N77bK9XNRDllG40ZUJL7wiGCZocUak",range:"A!A:E"},2:{id:"1iax4O8R0IiZd9N77bK9XNRDllG40ZUJL7wiGCZocUak",range:"B!A:E"},3:{id:"1iax4O8R0IiZd9N77bK9XNRDllG40ZUJL7wiGCZocUak",range:"C!A:E"}},cadoan:{schedules:{id:"1wJc-PNIW73HSGuYus5JBZw9IMr1fZ3J74GXm-e5b-8A",range:"A:C"},singers:{id:"1c-CU_cRvWy_Wp5PhrkKN_k-H3TKArH9-5z098Wx6Ibo",
...
a.id+":batchUpdate",c,h)},loadYears:function(){var g=a.defer(),c=[];e.getSheetData("liturgies.years").then(function(a){(a=a.data.values)&&a.forEach(function(a){a[1]&&c.push({id:a[0],name:a[1],start:l(a[2]),end:l(a[3])})});g.resolve(c)},function(a){console.log(a.data.error)});return g.promise},loadLiturgies:function(){for(var g=[],c=a.defer(),h=[],b=1;3>=b;b++)h.push(a.resolve(e.getSheetData("liturgies."+b),function(a){(a=a.data.values)&&a.forEach(function(a){a[3]&&g.push({id:a[0],name:a[1],year:a[2],
date:l(a[3]),special:a[4]})})}));a.all(h).then(function(){c.resolve(g)});return c.promise},loadSingers:function(){var g=a.defer(),c=[];e.getSheetData("cadoan.singers").then(function(a){(a=a.data.values)&&a.forEach(function(a){a[1]&&c.push({id:a[0],name:a[1]})});g.resolve(c)},function(a){console.log(a.data.error)});return g.promise},loadSchedules:function(g){var c=a.defer(),h=[];e.getSheetData("cadoan.schedules").then(function(a){(a=a.data.values)&&a.forEach(function(a){var c=l(a[0]),b=JSON.parse(a[1]);
a=JSON.parse(a[2]);a.forEach(function(a){var c=g.find(function(c){return c.id===a.id});c&&Object.assign(a,d.pick(c,"title","category","author","audio","url","folder"))});h.push({date:c,liturgy:b,songs:a})});c.resolve(h)},function(a){console.log(a.data.error)});return c.promise},listCategories:function(a){var c={},b;a=$jscomp.makeIterator(a);for(b=a.next();!b.done;b=a.next()){var g=b.value;b=c[g.category]||0;c[g.category]=b+1}return Object.keys(c).reduce(function(a,b){0<c[b]&&a.push(b);return a},[])},
listAuthors:function(a){var b={},g;a=$jscomp.makeIterator(a);for(g=a.next();!g.done;g=a.next()){var d=g.value;g=b[d.author]||0;b[d.author]=g+1}return Object.keys(b).reduce(function(a,c){1<b[c]&&a.push(c);return a},[])},sortByLocale:function(a,b){a&&a.sort(function(a,c){a="object"===typeof a&&b?a[b]:a;c="object"===typeof c&&b?c[b]:c;return a&&c?a.localeCompare(c):0})},sortCategories:function(a){e.sortByLocale(a);a&&a.sort(function(a,b){var c=e.getCategories().reverse();return c.indexOf(b)-c.indexOf(a)})}},
k=function(a){a=a.split(".");var b=f;a.forEach(function(a){b=b[a]});return b},l=function(a){a=new Date(Date.parse(a));a.setTime(a.getTime()+6E4*a.getTimezoneOffset());return a};return e}]);
