...
a=JSON.parse(a[2]);a.forEach(function(a){var c=g.find(function(c){return c.id===a.id});c&&Object.assign(a,d.pick(c,"title","category","author","audio","url","folder"))});h.push({date:c,liturgy:b,songs:a})});c.resolve(h)},function(a){console.log(a.data.error)});return c.promise},addSchedule:function(a){return e.appendSheetData("cadoan.schedules",a,{valueInputOption:"USER_ENTERED"})},updateSchedule:function(a){return e.updateSheetData("cadoan.schedules",a)},listCategories:function(a){var c={},b;a=$jscomp.makeIterator(a);
for(b=a.next();!b.done;b=a.next()){var g=b.value;b=c[g.category]||0;c[g.category]=b+1}return Object.keys(c).reduce(function(a,b){0<c[b]&&a.push(b);return a},[])},listAuthors:function(a){var b={},g;a=$jscomp.makeIterator(a);for(g=a.next();!g.done;g=a.next()){var d=g.value;g=b[d.author]||0;b[d.author]=g+1}return Object.keys(b).reduce(function(a,c){1<b[c]&&a.push(c);return a},[])},sortByLocale:function(a,b){a&&a.sort(function(a,c){a="object"===typeof a&&b?a[b]:a;c="object"===typeof c&&b?c[b]:c;return a&&
c?a.localeCompare(c):0})},sortCategories:function(a){e.sortByLocale(a);a&&a.sort(function(a,b){var c=e.getCategories().reverse();return c.indexOf(b)-c.indexOf(a)})}},k=function(a){a=a.split(".");var b=f;a.forEach(function(a){b=b[a]});return b},l=function(a){a=new Date(Date.parse(a));a.setTime(a.getTime()+6E4*a.getTimezoneOffset());return a};return e}]);
