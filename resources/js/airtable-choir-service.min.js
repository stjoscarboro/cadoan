...
app.factory("AirtableChoirService",["$q","$http","AirtableService","AppUtil",function(a,d,c,e){var b={},f={url:"https://api.airtable.com/v0/appct8Cpvuk7NtKiQ",key:Base64.decode("a2V5UUxrUm82andCeTdNWmg="),tables:{singers:{fields:["id","name","active"]},schedules:{fields:["id","date","liturgy","songs"]}}};b.getCategories=function(){return["Nh\u1eadp L\u1ec5","\u0110\u00e1p Ca","D\u00e2ng L\u1ec5","Hi\u1ec7p L\u1ec5","K\u1ebft L\u1ec5"]};b.loadSingers=function(){var b=a.defer(),g=[];c.getData("singers",
f).then(function(a){g=a.reduce(function(a,b){b.active&&a.push(b);return a},[]);b.resolve(g)});return b.promise};b.loadSchedules=function(b){var g=a.defer(),h=[];c.getData("schedules",f).then(function(a){a.forEach(function(a){var c=JSON.parse(a.songs);c.forEach(function(a){var c=b.find(function(b){return b.id===a.id});c&&Object.assign(a,e.pick(c,"title","category","author","audio","url","folder"))});h.push({id:a.id,refId:a.refId,date:a.date,liturgy:JSON.parse(a.liturgy),songs:c})});h.sort(function(a,
b){return a.date-b.date});g.resolve(h)});return g.promise};b.createSchedule=function(a){return c.createData("schedules",{fields:a},f)};b.updateSchedule=function(a,b){return c.updateData("schedules",a,{fields:b},f)};b.deleteSchedule=function(a){return c.deleteData("schedules",a,f)};b.listCategories=function(a){var c=a.reduce(function(a,b){a[b.category]=(a[b.category]||0)+1;return a},{});c=Object.keys(c).reduce(function(a,b){0<c[b]&&a.push(b);return a},[]);b.sortCategories(c);return c};b.listAuthors=
function(a){var c=a.reduce(function(a,b){a[b.author]=(a[b.author]||0)+1;return a},{});c=Object.keys(c).reduce(function(a,b){0<c[b]&&a.push(b);return a},[]);b.sortByLocale(c,"name");return c};b.sortByLocale=function(a,b){a&&a.sort(function(a,c){a="object"===typeof a&&b?a[b]:a;c="object"===typeof c&&b?c[b]:c;return a&&c?a.localeCompare(c):0})};b.sortCategories=function(a){b.sortByLocale(a);a&&a.sort(function(a,c){var d=b.getCategories().reverse();return d.indexOf(c)-d.indexOf(a)})};return b}]);
